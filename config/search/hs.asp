...
<%
Dim hs : hs = trim(Request.Form("hs"))
...
<form method="post">
	...
	<td align="center" bgcolor="#f8dfe0">
		...
		<td width="396" valign="top" bgcolor="#ffffff">
			...
			<tr>
			<td><img src="/images/common/pop_txt01.gif" width="101" height="19"></td>
			</tr>
			...
			<tr>
			<td><img src="/images/common/pop_line.gif" width="392" height="1"></td>
			</tr>
			...
			<td height="112" valign="top">
				...
				<tr>
				<td height="11" bgcolor="#FBFBFB" style="padding-left:30;"><img src="/images/common/pop_txt03.gif" width="47" height="13">
				<span style="color:green;"> (변경전/후 학교명이 모두 출력됩니다)</span>
				</td>
				</tr>
