...
<div style="width:98%;border:4px solid #f8dfe0;">
		...
		<td valign="top" bgcolor="#ffffff">
			...
			<tr>
			<td><img src="images/pop_txt01.gif" width="101" height="19">&nbsp;<span style="color:green;"> (문의 02-2063-0700)</span></td>
			</tr>
			...
			<td height="112" valign="top">
				...
				<tr>
				<td height="22" bgcolor="#FBFBFB" style="padding-left:10;"><span style="font-size:12;">고등학교명</span>&nbsp;&nbsp;<input name="hs" type="text" style='border:1 solid #DDDBDE; color=#676767 font-size:9pt; background-color:#ffffff' value="<%=hs%>" size="24" style="ime-mode:active;font-size:12;"  class="box">
				...
				if (hs<>"") then
					...
					if not ors.eof and not ors.bof then
						while not ors.eof
							%>
							<a href="javascript:goSelect('<%=oRs("HsCode")%>','<%=oRs("Name")%>');" title="선택하세요!">(<%=oRs("Sido")%>)&nbsp;<%=oRs("Name")%></a><br>
							<%
							oRs.Movenext
						wend
					else
